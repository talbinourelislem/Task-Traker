...
const Successmark = require("./Successmark.png")
...
const Changed = ({navigation}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
        <Image source={Successmark} style={styles.image2} resizeMode='contain' />
        <Text style={styles.title}>Password Changed!</Text>
        <Text style={styles.info}>Your password has been changed successfully.</Text>
